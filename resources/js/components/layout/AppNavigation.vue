...
const { activePanel } = usePlannerContext();
</script>
...
<template>
    <aside class="nav-rail surface">
        ...
        <button
            class="icon-button"
            :class="{ active: activePanel === 'deadlines' }"
            title="Deadline"
            @click="activePanel = 'deadlines'"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-calendar-alert-icon lucide-calendar-alert"
            >
                <path d="M8 2v4" />
                <path d="M16 2v4" />
                <rect width="18" height="18" x="3" y="4" rx="2" />
        ...
        <button
            class="icon-button"
            :class="{ active: activePanel === 'pastEvents' }"
            title="Eventi passati"
            @click="activePanel = 'pastEvents'"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
